...
function Disable-InternetExplorerESC {
    ...
    Write-Host "[SUCCESS] IE Enhanced Security Configuration (ESC) has been disabled." -ForegroundColor Green
}
function Enable-InternetExplorerESC {
    ...
    Stop-Process -Name Explorer
    Write-Host "[SUCCESS] IE Enhanced Security Configuration (ESC) has been enabled." -ForegroundColor Green
}
function Disable-UserAccessControl {
    Set-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" -Name "ConsentPromptBehaviorAdmin" -Value 00000000
    Write-Host "[SUCCESS] User Access Control (UAC) has been disabled." -ForegroundColor Green    
}
